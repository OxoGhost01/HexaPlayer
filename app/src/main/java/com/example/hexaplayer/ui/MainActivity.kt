package com.example.hexaplayer.ui
...
import com.example.hexaplayer.databinding.ActivityMainBinding
import com.example.hexaplayer.ui.download.DownloadFragment
import com.example.hexaplayer.ui.equalizer.EqualizerFragment
import com.example.hexaplayer.ui.home.HomeFragment
import com.example.hexaplayer.ui.player.PlayerFragment
import com.example.hexaplayer.ui.settings.SettingsFragment
...
class MainActivity : AppCompatActivity() {
    ...
    private fun setupBottomNav() {
        ...
        // Apply theme-aware tint programmatically so accent changes work
    ...
    private fun observePlayback() {
        viewModel.currentSong.observe(this) { song ->
            if (song == null) {
                // Only hidden at startup; once a song plays we keep bar visible
                ...
                loadPlayerBarArtWithPalette(song.albumId)
    ...
    private fun loadPlayerBarArtWithPalette(albumId: Long) {
